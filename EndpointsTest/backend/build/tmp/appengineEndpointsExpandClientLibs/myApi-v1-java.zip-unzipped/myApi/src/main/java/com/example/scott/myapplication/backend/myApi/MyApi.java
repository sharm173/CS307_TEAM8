 ...
 * on 2015-10-15 at 05:25:48 UTC 
 * Modify at your own risk.
 */

package com.example.scott.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getNames".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetNames#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetNames getNames() throws java.io.IOException {
    GetNames result = new GetNames();
    initialize(result);
    return result;
  }

  public class GetNames extends MyApiRequest<com.example.scott.myapplication.backend.myApi.model.MyBeanCollection> {
     ...
     * parameters, call the {@link GetNames#execute()} method to invoke the remote operation. <p>
     * {@link
     * GetNames#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetNames() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.scott.myapplication.backend.myApi.model.MyBeanCollection.class);
    }
    ...
    @Override
    public GetNames setAlt(java.lang.String alt) {
      return (GetNames) super.setAlt(alt);
    }

    @Override
    public GetNames setFields(java.lang.String fields) {
      return (GetNames) super.setFields(fields);
    }

    @Override
    public GetNames setKey(java.lang.String key) {
      return (GetNames) super.setKey(key);
    }

    @Override
    public GetNames setOauthToken(java.lang.String oauthToken) {
      return (GetNames) super.setOauthToken(oauthToken);
    }

    @Override
    public GetNames setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetNames) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetNames setQuotaUser(java.lang.String quotaUser) {
      return (GetNames) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetNames setUserIp(java.lang.String userIp) {
      return (GetNames) super.setUserIp(userIp);
    }

    @Override
    public GetNames set(String parameterName, Object value) {
      return (GetNames) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.scott.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.scott.myapplication.backend.myApi.model.MyBean.class);
