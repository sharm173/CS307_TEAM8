...
public final class Profile extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<MyBean> tags;
   ...
   */
  public Profile setGroups(java.util.List<Group> groups) {
    this.groups = groups;
    return this;
  }
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<MyBean> getTags() {
    return tags;
  }
   ...
   */
  public Profile setTags(java.util.List<MyBean> tags) {
    this.tags = tags;
    return this;
  }
