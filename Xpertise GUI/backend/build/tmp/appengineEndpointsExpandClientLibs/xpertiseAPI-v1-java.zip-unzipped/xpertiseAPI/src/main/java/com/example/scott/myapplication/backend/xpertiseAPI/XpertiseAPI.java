...
public class XpertiseAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public ProfilePost profilePost(java.lang.String firstName, java.lang.String lastName, java.lang.String password, java.lang.String email, java.lang.String city) throws java.io.IOException {
    ProfilePost result = new ProfilePost(firstName, lastName, password, email, city);
    initialize(result);
    return result;
  }

  public class ProfilePost extends XpertiseAPIRequest<Void> {
     ...
     * @since 1.13
     */
    protected ProfilePost(java.lang.String firstName, java.lang.String lastName, java.lang.String password, java.lang.String email, java.lang.String city) {
