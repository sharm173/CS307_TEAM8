...
public class XpertiseAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public ProfilePostReview profilePostReview(java.lang.Integer reviewerPid, java.lang.Integer revieweePid, java.lang.Integer stars, java.lang.String description) throws java.io.IOException {
    ProfilePostReview result = new ProfilePostReview(reviewerPid, revieweePid, stars, description);
    initialize(result);
    return result;
  }
  ...
  public class ProfilePostReview extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean> {
    ...
    private static final String REST_PATH = "postReview/{reviewerPid}/{revieweePid}/{stars}/{description}";
     ...
     * @since 1.13
     */
    protected ProfilePostReview(java.lang.Integer reviewerPid, java.lang.Integer revieweePid, java.lang.Integer stars, java.lang.String description) {
      super(XpertiseAPI.this, "POST", REST_PATH, null, com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean.class);
