...
public class XpertiseAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://xpertiseservergae.appspot.com/_ah/api/";
  ...
  public class API {
    ...
    /**
     * Create a request for the method "aPI.profileNoGroups".
     *
     * This request holds the parameters needed by the xpertiseAPI server.  After setting any optional
     * parameters, call the {@link ProfileNoGroups#execute()} method to invoke the remote operation.
     *
     * @param pid
     * @return the request
     */
    public ProfileNoGroups profileNoGroups(java.lang.Integer pid) throws java.io.IOException {
      ProfileNoGroups result = new ProfileNoGroups(pid);
      initialize(result);
      return result;
    }

    public class ProfileNoGroups extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.Profile> {

      private static final String REST_PATH = "profileNoGroups/{pid}";

      /**
       * Create a request for the method "aPI.profileNoGroups".
       *
       * This request holds the parameters needed by the the xpertiseAPI server.  After setting any
       * optional parameters, call the {@link ProfileNoGroups#execute()} method to invoke the remote
       * operation. <p> {@link ProfileNoGroups#initialize(com.google.api.client.googleapis.services.Abst
       * ractGoogleClientRequest)} must be called to initialize this instance immediately after invoking
       * the constructor. </p>
       *
       * @param pid
       * @since 1.13
       */
      protected ProfileNoGroups(java.lang.Integer pid) {
      ...
      @Override
      public ProfileNoGroups setAlt(java.lang.String alt) {
        return (ProfileNoGroups) super.setAlt(alt);
      }

      @Override
      public ProfileNoGroups setFields(java.lang.String fields) {
        return (ProfileNoGroups) super.setFields(fields);
      }

      @Override
      public ProfileNoGroups setKey(java.lang.String key) {
        return (ProfileNoGroups) super.setKey(key);
      }

      @Override
      public ProfileNoGroups setOauthToken(java.lang.String oauthToken) {
        return (ProfileNoGroups) super.setOauthToken(oauthToken);
      }

      @Override
      public ProfileNoGroups setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (ProfileNoGroups) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public ProfileNoGroups setQuotaUser(java.lang.String quotaUser) {
        return (ProfileNoGroups) super.setQuotaUser(quotaUser);
      }

      @Override
      public ProfileNoGroups setUserIp(java.lang.String userIp) {
        return (ProfileNoGroups) super.setUserIp(userIp);
      }
      ...
      public ProfileNoGroups setPid(java.lang.Integer pid) {
        this.pid = pid;
        return this;
      }

      @Override
      public ProfileNoGroups set(String parameterName, Object value) {
        return (ProfileNoGroups) super.set(parameterName, value);
      }
    }
  ...
  /**
   * Create a request for the method "group_getTags".
   *
   * This request holds the parameters needed by the xpertiseAPI server.  After setting any optional
   * parameters, call the {@link GroupGetTags#execute()} method to invoke the remote operation.
   *
   * @param gid
   * @return the request
   */
  public GroupGetTags groupGetTags(java.lang.Integer gid) throws java.io.IOException {
    GroupGetTags result = new GroupGetTags(gid);
    initialize(result);
    return result;
  }

  public class GroupGetTags extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.MyBeanCollection> {

    private static final String REST_PATH = "groupGetTags/{gid}";

    /**
     * Create a request for the method "group_getTags".
     *
     * This request holds the parameters needed by the the xpertiseAPI server.  After setting any
     * optional parameters, call the {@link GroupGetTags#execute()} method to invoke the remote
     * operation. <p> {@link
     * GroupGetTags#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param gid
     * @since 1.13
     */
    protected GroupGetTags(java.lang.Integer gid) {
      super(XpertiseAPI.this, "POST", REST_PATH, null, com.example.scott.myapplication.backend.xpertiseAPI.model.MyBeanCollection.class);
      this.gid = com.google.api.client.util.Preconditions.checkNotNull(gid, "Required parameter gid must be specified.");
    }

    @Override
    public GroupGetTags setAlt(java.lang.String alt) {
      return (GroupGetTags) super.setAlt(alt);
    }

    @Override
    public GroupGetTags setFields(java.lang.String fields) {
      return (GroupGetTags) super.setFields(fields);
    }

    @Override
    public GroupGetTags setKey(java.lang.String key) {
      return (GroupGetTags) super.setKey(key);
    }

    @Override
    public GroupGetTags setOauthToken(java.lang.String oauthToken) {
      return (GroupGetTags) super.setOauthToken(oauthToken);
    }

    @Override
    public GroupGetTags setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GroupGetTags) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GroupGetTags setQuotaUser(java.lang.String quotaUser) {
      return (GroupGetTags) super.setQuotaUser(quotaUser);
    }

    @Override
    public GroupGetTags setUserIp(java.lang.String userIp) {
      return (GroupGetTags) super.setUserIp(userIp);
    }
    ...
    public GroupGetTags setGid(java.lang.Integer gid) {
      this.gid = gid;
      return this;
    }

    @Override
    public GroupGetTags set(String parameterName, Object value) {
      return (GroupGetTags) super.set(parameterName, value);
    }
  }
  ...
  /**
   * Create a request for the method "group_postPost".
   *
   * This request holds the parameters needed by the xpertiseAPI server.  After setting any optional
   * parameters, call the {@link GroupPostPost#execute()} method to invoke the remote operation.
   *
   * @param gid
   * @param pid
   * @param title
   ...
   * @return the request
   */
  public GroupPostPost groupPostPost(java.lang.Integer gid, java.lang.Integer pid, java.lang.String title, java.lang.String body) throws java.io.IOException {
    GroupPostPost result = new GroupPostPost(gid, pid, title, body);
    initialize(result);
    return result;
  }

  public class GroupPostPost extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean> {

    private static final String REST_PATH = "postPost/{gid}/{pid}/{title}/{body}";

    /**
     * Create a request for the method "group_postPost".
     *
     * This request holds the parameters needed by the the xpertiseAPI server.  After setting any
     * optional parameters, call the {@link GroupPostPost#execute()} method to invoke the remote
     * operation. <p> {@link GroupPostPost#initialize(com.google.api.client.googleapis.services.Abstra
     ...
     * @since 1.13
     */
    protected GroupPostPost(java.lang.Integer gid, java.lang.Integer pid, java.lang.String title, java.lang.String body) {
      super(XpertiseAPI.this, "POST", REST_PATH, null, com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean.class);
      this.gid = com.google.api.client.util.Preconditions.checkNotNull(gid, "Required parameter gid must be specified.");
      this.pid = com.google.api.client.util.Preconditions.checkNotNull(pid, "Required parameter pid must be specified.");
    ...
    @Override
    public GroupPostPost setAlt(java.lang.String alt) {
      return (GroupPostPost) super.setAlt(alt);
    }

    @Override
    public GroupPostPost setFields(java.lang.String fields) {
      return (GroupPostPost) super.setFields(fields);
    }

    @Override
    public GroupPostPost setKey(java.lang.String key) {
      return (GroupPostPost) super.setKey(key);
    }

    @Override
    public GroupPostPost setOauthToken(java.lang.String oauthToken) {
      return (GroupPostPost) super.setOauthToken(oauthToken);
    }

    @Override
    public GroupPostPost setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GroupPostPost) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GroupPostPost setQuotaUser(java.lang.String quotaUser) {
      return (GroupPostPost) super.setQuotaUser(quotaUser);
    }

    @Override
    public GroupPostPost setUserIp(java.lang.String userIp) {
      return (GroupPostPost) super.setUserIp(userIp);
    }
    ...
    public GroupPostPost setGid(java.lang.Integer gid) {
      this.gid = gid;
      return this;
    }
    ...
    public GroupPostPost setPid(java.lang.Integer pid) {
      this.pid = pid;
      return this;
    }
    ...
    public GroupPostPost setTitle(java.lang.String title) {
      this.title = title;
      return this;
    }
    ...
    public GroupPostPost setBody(java.lang.String body) {
      this.body = body;
      return this;
    }

    @Override
    public GroupPostPost set(String parameterName, Object value) {
      return (GroupPostPost) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "group_searchByName".
   *
   * This request holds the parameters needed by the xpertiseAPI server.  After setting any optional
   * parameters, call the {@link GroupSearchByName#execute()} method to invoke the remote operation.
   *
   * @param name
   * @return the request
   */
  public GroupSearchByName groupSearchByName(java.lang.String name) throws java.io.IOException {
    GroupSearchByName result = new GroupSearchByName(name);
    initialize(result);
    return result;
  }

  public class GroupSearchByName extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.Group> {

    private static final String REST_PATH = "groupSearchByName/{name}";

    /**
     * Create a request for the method "group_searchByName".
     *
     * This request holds the parameters needed by the the xpertiseAPI server.  After setting any
     * optional parameters, call the {@link GroupSearchByName#execute()} method to invoke the remote
     * operation. <p> {@link GroupSearchByName#initialize(com.google.api.client.googleapis.services.Ab
     ...
     * @since 1.13
     */
    protected GroupSearchByName(java.lang.String name) {
      super(XpertiseAPI.this, "POST", REST_PATH, null, com.example.scott.myapplication.backend.xpertiseAPI.model.Group.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }

    @Override
    public GroupSearchByName setAlt(java.lang.String alt) {
      return (GroupSearchByName) super.setAlt(alt);
    }

    @Override
    public GroupSearchByName setFields(java.lang.String fields) {
      return (GroupSearchByName) super.setFields(fields);
    }

    @Override
    public GroupSearchByName setKey(java.lang.String key) {
      return (GroupSearchByName) super.setKey(key);
    }

    @Override
    public GroupSearchByName setOauthToken(java.lang.String oauthToken) {
      return (GroupSearchByName) super.setOauthToken(oauthToken);
    }

    @Override
    public GroupSearchByName setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GroupSearchByName) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GroupSearchByName setQuotaUser(java.lang.String quotaUser) {
      return (GroupSearchByName) super.setQuotaUser(quotaUser);
    }

    @Override
    public GroupSearchByName setUserIp(java.lang.String userIp) {
      return (GroupSearchByName) super.setUserIp(userIp);
    }
    ...
    public GroupSearchByName setName(java.lang.String name) {
      this.name = name;
      return this;
    }

    @Override
    public GroupSearchByName set(String parameterName, Object value) {
      return (GroupSearchByName) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "group_setTag".
   *
   * This request holds the parameters needed by the xpertiseAPI server.  After setting any optional
   * parameters, call the {@link GroupSetTag#execute()} method to invoke the remote operation.
   *
   * @param gid
   * @param tag
   * @return the request
   */
  public GroupSetTag groupSetTag(java.lang.Integer gid, java.lang.String tag) throws java.io.IOException {
    GroupSetTag result = new GroupSetTag(gid, tag);
    initialize(result);
    return result;
  }

  public class GroupSetTag extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean> {

    private static final String REST_PATH = "groupSetTag/{gid}/{tag}";

    /**
     * Create a request for the method "group_setTag".
     *
     * This request holds the parameters needed by the the xpertiseAPI server.  After setting any
     * optional parameters, call the {@link GroupSetTag#execute()} method to invoke the remote
     * operation. <p> {@link
     * GroupSetTag#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param gid
     * @param tag
     * @since 1.13
     */
    protected GroupSetTag(java.lang.Integer gid, java.lang.String tag) {
      super(XpertiseAPI.this, "POST", REST_PATH, null, com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean.class);
      this.gid = com.google.api.client.util.Preconditions.checkNotNull(gid, "Required parameter gid must be specified.");
    ...
    @Override
    public GroupSetTag setAlt(java.lang.String alt) {
      return (GroupSetTag) super.setAlt(alt);
    }

    @Override
    public GroupSetTag setFields(java.lang.String fields) {
      return (GroupSetTag) super.setFields(fields);
    }

    @Override
    public GroupSetTag setKey(java.lang.String key) {
      return (GroupSetTag) super.setKey(key);
    }

    @Override
    public GroupSetTag setOauthToken(java.lang.String oauthToken) {
      return (GroupSetTag) super.setOauthToken(oauthToken);
    }

    @Override
    public GroupSetTag setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GroupSetTag) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GroupSetTag setQuotaUser(java.lang.String quotaUser) {
      return (GroupSetTag) super.setQuotaUser(quotaUser);
    }

    @Override
    public GroupSetTag setUserIp(java.lang.String userIp) {
      return (GroupSetTag) super.setUserIp(userIp);
    }
    ...
    public GroupSetTag setGid(java.lang.Integer gid) {
      this.gid = gid;
      return this;
    }
    ...
    public GroupSetTag setTag(java.lang.String tag) {
      this.tag = tag;
      return this;
    }

    @Override
    public GroupSetTag set(String parameterName, Object value) {
      return (GroupSetTag) super.set(parameterName, value);
    }
  }
