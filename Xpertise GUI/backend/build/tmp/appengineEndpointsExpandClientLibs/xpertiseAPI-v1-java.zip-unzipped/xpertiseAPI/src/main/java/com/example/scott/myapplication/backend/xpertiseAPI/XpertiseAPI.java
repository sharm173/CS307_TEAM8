...
public class XpertiseAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Profile {
    ...
    public class List extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.ProfileCollection> {
    ...
    public class Post extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.Profile> {

      private static final String REST_PATH = "profile/{firstName}/{lastName}/{password}/{email}/{city}";
  ...
  public class SayHi extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean> {
