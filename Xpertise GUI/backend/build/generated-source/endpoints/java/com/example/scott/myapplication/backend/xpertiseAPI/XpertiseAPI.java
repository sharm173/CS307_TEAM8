...
public class XpertiseAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public ProfileCity profileCity(java.lang.Integer pid) throws java.io.IOException {
    ProfileCity result = new ProfileCity(pid);
    initialize(result);
    return result;
  }
  ...
  public class ProfileCity extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.ProfileCollection> {
    ...
    private static final String REST_PATH = "profilesInCity/{pid}";
     ...
     * @since 1.13
     */
    protected ProfileCity(java.lang.Integer pid) {
   ...
   * @return the request
   */
  public ProfilePostReview profilePostReview(java.lang.Integer pid) throws java.io.IOException {
    ProfilePostReview result = new ProfilePostReview(pid);
    initialize(result);
    return result;
  }
  ...
  public class ProfilePostReview extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean> {
    ...
    private static final String REST_PATH = "postReview/{pid}";
     ...
     * @since 1.13
     */
    protected ProfilePostReview(java.lang.Integer pid) {
      super(XpertiseAPI.this, "POST", REST_PATH, null, com.example.scott.myapplication.backend.xpertiseAPI.model.MyBean.class);
      this.pid = com.google.api.client.util.Preconditions.checkNotNull(pid, "Required parameter pid must be specified.");
    }
    ...
    public ProfilePostReview setPid(java.lang.Integer pid) {
      this.pid = pid;
      return this;
    }
   ...
   * @return the request
   */
  public ProfileRadius profileRadius(java.lang.Integer pid, java.lang.Integer miles) throws java.io.IOException {
  ...
  public class ProfileRadius extends XpertiseAPIRequest<com.example.scott.myapplication.backend.xpertiseAPI.model.ProfileCollection> {
     ...
     * @since 1.13
     */
    protected ProfileRadius(java.lang.Integer pid, java.lang.Integer miles) {
      super(XpertiseAPI.this, "POST", REST_PATH, null, com.example.scott.myapplication.backend.xpertiseAPI.model.ProfileCollection.class);
      this.pid = com.google.api.client.util.Preconditions.checkNotNull(pid, "Required parameter pid must be specified.");
    ...
    @com.google.api.client.util.Key
    private java.lang.Integer miles;

    /**

     */
    public java.lang.Integer getMiles() {
      return miles;
    }

    public ProfileRadius setMiles(java.lang.Integer miles) {
      this.miles = miles;
      return this;
    }
